    ...
    <div class="flex flex-col">
          ...
          <button class="border-0 rounded-3xl h-6 w-6" @click="back">
            <svg viewBox="2 3 20 20" fill="currentColor" class="w-5 h-5">
              ...
              <path
                ...
                style=""
                data-bx-origin="-0.49997 -0.500225"
                transform="matrix(-1, 0, 0, -1, 64.000016, 63.992002)"
              ></path>
            </svg>
          </button>
          <button
            class="mx-4 disabled:text-slate-500 border-0 rounded-3xl h-10 w-10"
            :disabled="!loaded"
            @click="pause"
          >
            <svg v-if="paused" viewBox="0 0 24 24" class="h-10 w-10">
              <defs>
                <linearGradient
                  ...
                  x2="12.749"
                  y2="16.753"
                  gradientTransform="matrix(0.919647, 0, 0, 1.061533, 1.274691, -0.78271)"
                ...
                <linearGradient
                  ...
                  x2="11.41"
                  y2="20.367"
                  gradientTransform="matrix(1.264939, 0, 0, 1.237333, -2.54417, -3.380649)"
                  xlink:href="#gradient-ccf"
                ></linearGradient>
              </defs>
              <rect
              ...
              <path
                ...
                style="paint-order: fill; fill: url(#gradient-ccf-0)"
                data-bx-origin="0.375014 0.499992"
              ></path>
              <ellipse
                style="
                  fill: none;
            ...
            <svg v-else viewBox="0 0 24 24" class="h-9 w-9">
              <defs>
                ...
                <linearGradient
                  ...
                  x2="9.693"
                  y2="15.942"
                  gradientTransform="matrix(1.12965, 0, 0, 1.206404, -0.678692, -2.041866)"
                  xlink:href="#gradient-ccf"
                ></linearGradient>
                <linearGradient
                  id="gradient-ccf-2"
                  ...
                  x2="9.693"
                  y2="15.942"
                  gradientTransform="matrix(1.121797, 0, 0, 1.206404, 3.249403, -2.124129)"
                  xlink:href="#gradient-ccf"
                ></linearGradient>
              </defs>
              <rect
              ...
              ></ellipse>
              <path
                style="fill: url(#gradient-ccf-0)"
                d="M 10.263 7.19 H 11.277 V 17.19 H 10.263 A 1 1 0 0 1 9.263 16.19 V 8.19 A 1 1 0 0 1 10.263 7.19 Z"
                data-bx-shape="rect 9.263 7.19 2.014 10 1 0 0 1 1@691415ba"
              ></path>
              <path
                style="fill: url(#gradient-ccf-2)"
                d="M 13.123 7.108 H 14.123 A 1 1 0 0 1 15.123 8.108 V 16.108 A 1 1 0 0 1 14.123 17.108 H 13.123 V 7.108 Z"
                data-bx-shape="rect 13.123 7.108 2 10 0 1 1 0 1@33f88c23"
              ></path>
            </svg>
          </button>
          <button
            class="border-0 rounded-3xl h-6 w-6"
            @click="forward"
          >
            <svg viewBox="2 3 20 20" fill="currentColor" class="w-5 h-5">
              <path
      ...
      <div class="flex flex-row justify-end text-gray-400">
        <button v-if="extendedControls" class="mx-2" @click="muted =! muted">
          <svg v-if="!muted" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
        ...
        <button v-if="extendedControls" class="text-xs mx-5 h-5 w-12 rounded-md border-2 border-gray-800" @click="togglePlaybackRate">
