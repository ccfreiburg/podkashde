  ...
  <div class="m-3">
    ...
    <div class="
      ...
      <div class="flex flex-col sm:w-1/2 w-full">
        ...
        <single-select class="mx-3" :options="podcastOptions" :name="'test'" label="podcast.change"  v-model:value="selectedPodcast"></single-select>
        <button class="
              mx-3
              mt-4
              p-2
        ...
        <div class="m-3 h-full border-orange-300 border-2 rounded-md mt-4">
          <div class="text-ml bg-orange-300 p-1">Selected</div>
          <div class="p-1">
