...
ENV DATABASE_PATH ="/data/podcasts.sqlite";
ENV DATA_PATH ="/var/www";
# ENV NUXT_PUBLIC_URL ${NUXT_PUBLIC_URL}
# ENV NUXT_PUBLIC_API_BASE ${NUXT_PUBLIC_API_BASE}
# ENV NUXT_PUBLIC_MEDIA_BASE ${NUXT_PUBLIC_MEDIA_BASE}
# ENV NUXT_PUBLIC_SKIN ${NUXT_PUBLIC_SKIN}
# ENV NUXT_PUBLIC_ENABLE_DARK_MODE ${NUXT_PUBLIC_ENABLE_DARK_MODE}
# ENV NUXT_PUBLIC_LOGO ${NUXT_PUBLIC_LOGO}
# ENV NUXT_PUBLIC_LOGO_DARK ${NUXT_PUBLIC_LOGO_DARK}
# ENV NUXT_PUBLIC_EXT_MENU_DE ${NUXT_PUBLIC_EXT_MENU_DE}
